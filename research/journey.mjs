...
function problem(id,phase,title,options,enTitle,enOptions){return {id,phase,title,multi:true,followups:options,options:[...options,'Etwas anderes','Keine Schwierigkeiten','Kann ich nicht beurteilen'],exclusive:['Keine Schwierigkeiten','Kann ich nicht beurteilen'],other:['Etwas anderes','Was war sonst schwierig?'],en:{title:enTitle,options:[...enOptions,'Something else','No difficulties','I cannot judge'],other:'What else was difficult?',free:enExample}};}
